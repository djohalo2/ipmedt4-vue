...
export default new VueRouter({
  ...
  routes: [
    ...
    { path: '/behandeling/:typeBehandeling/medicatie/:typeMedicijn', component: load('patient/medicatie/MedicatiePage') },
    { path: '/behandeling/:typeBehandeling/oefeningen/:typeOefening', component: load('patient/oefeningen/OefeningPage') },
    // Paths voor arts
