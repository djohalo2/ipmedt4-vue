    ...
    <div class="layout-view">
      <div class="layout-padding">
        ...
        <div class="calendar">
          ...
          <afspraak-card v-if="!isFetching" v-for="(appointment, index) in appointments" :key="index" :id="appointment.id" :start="appointment.start" :eind="appointment.end" :name="appointment.title" :patientId="appointment.patient_id"></afspraak-card>
