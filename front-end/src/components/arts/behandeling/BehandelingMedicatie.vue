  ...
  <div>
    <div class="card">
      ...
      <div class="card-content">
        <div class="list">
          <list-item v-for="medicijn in medicatie" :key="medicijn.id" :state="state" type="medicine" :id="medicijn.id" :therapyId="medicijn.pivot.therapy_id" :title="medicijn.name"></list-item>
        </div>
      </div>
    </div>
