...
$api->version('v1', ['middleware' => 'api.throttle', 'limit' => 10000, 'expires' => 5], function ($api)
{
    ...
    $api->group(['middleware' => ['api.auth', 'api']], function ($api)
    {
        ...
        $api->put('patient/update/{id}', ['as' => 'patient.update',  'uses' => '\App\Http\Controllers\PatientController@update']);
        ...
        $api->get('doctor/notes/{therapy_id}', ['as' => 'doctor.notes',  'uses' => '\App\Http\Controllers\DoctorNoteController@show']);
